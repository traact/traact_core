...
#ifndef TRAACT_CORE_SRC_TRAACT_DATAFLOW_TASKFLOW_GRAPH_CONNECTIONGRAPHBUILDER_H_
#define TRAACT_CORE_SRC_TRAACT_DATAFLOW_TASKFLOW_GRAPH_CONNECTIONGRAPHBUILDER_H_
...
#endif //TRAACT_CORE_SRC_TRAACT_DATAFLOW_TASKFLOW_GRAPH_CONNECTIONGRAPHBUILDER_H_
