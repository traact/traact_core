/*
 * all credit goes to https://loosechainsaw.github.io/c++/2020/02/19/ringbuffer/
**/

#ifndef TRAACTMULTI_RINGBUFFER_H
#define TRAACTMULTI_RINGBUFFER_H
...
#endif //TRAACTMULTI_RINGBUFFER_H
